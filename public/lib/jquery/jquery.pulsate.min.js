(function (c) {
        ...
        g = function (a, b, d) {
            ...
            var h = (e - d) / e,
                f = a
                    .color
                    .split(","),
                h = "rgba(" + f[0].split("(")[1] + "," + f[1] + "," + f[2].split(")")[0] + "," + h + ")",
                f = {
                    outline: "2px solid " + h
                };
            a.glow && (f["box-shadow"] = "0px 0px " + parseInt(d / 1.5) + "px " + h);
            f["outline-offset"] = d + "px";
            c(b).css(f);
            b.timer && clearTimeout(b.timer);
            b.timer = setTimeout(function () {
                if (d >= e && !a.repeat) 
                    return c(b).pulsate("destroy"),
                    !1;
                if (d >= e && !0 !== a.repeat && !isNaN(a.repeat) && 0 < a.repeat) 
                    a.repeat -= 1;
                else if (a.pause && d >= e) 
                    return l(a, b, d + 1),
                    !1;
    ...
    c.fn.pulsate = function (a) {
        if (k[a]) 
            return k[a].apply(this, Array.prototype.slice.call(arguments, 1));
